...
// This is used with the data coming from ZHaireS:
void Anita::MakeCRArraysforFFT(double *vsignalarray_e,double *vsignalarray_h,double *vsignal_e_forfft,double *vsignal_h_forfft) {
  ...
  for (int i=0;i<NFREQ;i++) {
	...
	ifirstnonzero=ifour;
      ...
      vsignal_e_forfft[2*ifour]=vsignalarray_e[i]; // phases is 90 deg.

      //      cout << "ifour, vsignal is " << ifour << " " << vsignal_e_forfft[2*ifour] << "\n";

      vsignal_e_forfft[2*ifour+1]=vsignalarray_e[i]; // phase is 90 deg.
      // the 2/(nfour/2) needs to be included since were using Tools::realft with the -1 setting

      vsignal_h_forfft[2*ifour]=vsignalarray_h[i]; // what to do about phases
      vsignal_h_forfft[2*ifour+1]=vsignalarray_h[i]; // what to do about phases
      // the 2/(nfour/2) needs to be included since were using Tools::realft with the -1 setting
...
// This is used with the FT data coming from ApplyAntennaGain:
void Anita::MakeCR1ArraysforFFT(double *vsignalarray_e,double *vsignalarray_h,double *vsignal_e_forfft,double *vsignal_h_forfft) {
