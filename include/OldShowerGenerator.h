...
////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef OLD_ICEMC_SHOWER_GENERATOR_H
#define OLD_ICEMC_SHOWER_GENERATOR_H
...
namespace icemc{
  ...
  public:
    ...
    double pnu;
    TVector3 axis;
    ClassDef(OldShower, 1)
  };
  

  //! Secondary interactions
  class OldShowerGenerator : public RNG {
  ...
  private:
    ...
    void ReadOldShowerGenerator(); // read in prob. dist. for secondary interactions
  ...
  public:
    OldShowerGenerator(const Settings* settings);
    ...
    OldShower GetEMFrac(Neutrino::Flavor nuflavor,
