...
#include "Constants.h"
#include "AskaryanRadiationModel.h"///@todo this for for N_AIR, but needs to be moved
...
namespace icemc {
  ...
  public:
    ...
    Seavey(const TVector3& positionV, const TVector3& positionH,
	   ...
	   const Settings* settings = NULL, double refractiveIndexOfMedium = icemc::AskaryanRadiationModel::N_AIR);
  ...
  private:
    ...
    double fRefractiveIndex = icemc::AskaryanRadiationModel::N_AIR; ///< This is the refractive index at the antenna (formerly known as nmedium_receiver)
    bool fDebug = false;
