...
void AntTrigger::ConvertInputWFtoAntennaWF(Settings *settings1, Anita *anita1, Screen *panel1, double *vmmhz, double hitangle_e, double hitangle_h, double e_component, double h_component)
{
