...
private: //stuff other programs arent allowed to touch
  ...
  */
  ...
  vector<double> mydensityvector;/*!<Filled with density at each step> */
  
  vector<double> myavgdensityvector;/*!<Filled with avg density from earth-in to interaction point.> */
  ...
  vector<double> etaufarray;/*! <filled with all the possible tau final energies.> */
  vector<double> PDFarray;/*! <Filled with the total weight(a running sum) up to the current final energy.> */
