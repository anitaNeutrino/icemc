// Macro to produce standard flux/limit plot in ANITA's energy range w/ a custom generated flux.
...
void customFluxLimitPlot(){

  string outname = "LimitWCustomFlux";
...
//  printf("a4 ul = %g\n", A4ul);
  ...
  g_Kotera_shade->GetXaxis()->SetLimits(0.999e18,1.e21); // zoom little bit
  ...
  g_Ahlers->SetLineStyle(9);
  g_Ahlers->Draw("l");

  TGraph *g_kkss = GetFlux("kkss_envo.dat");
  g_kkss->SetLineWidth(3);
  g_kkss->SetLineStyle(9);
  g_kkss->SetLineColor(kMagenta);
  g_kkss->Draw("l");

  // Your custom generated flux here
  TGraph *g_custom20 = GetFlux("simFlux_E23.0_A2.0_N40000000_c1_s1_z3.0.dat");
  g_custom20->SetLineWidth(3);
  g_custom20->SetLineStyle(9);
  g_custom20->SetLineColor(kGreen+1);
  g_custom20->Draw("l");

  TGraph* gTakami = getTakami();
  gTakami->SetLineWidth(3);
  gTakami->SetLineStyle(9);
  gTakami->SetLineColor(kOrange);
  gTakami->Draw("l");
  ...
  Leg_Const2_2 -> AddEntry(g_custom20, "Simulation '20", "l"); // Your custom generated flux
