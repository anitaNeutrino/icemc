...
void icemc::Counting::findCosthetaPhiBins(Geoid::Position r_in,int &icostheta,int &iphi) {
...
void icemc::Counting::IncrementWeights_r_in(Geoid::Position r_in,double weight) {
  int iphi,icostheta;
