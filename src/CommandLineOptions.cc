...
icemc::CommandLineOptions::CommandLineOptions(int argc, char* argv[], Settings& settings) :
  outputdir("."), input(""), run_no(0)
{
  ...
  settings.fOutputDir = outputdir;
  settings.fRun = run_no;
  settings.fStartNu = startNu;
}


void icemc::CommandLineOptions::setExecName(char* argv0){
