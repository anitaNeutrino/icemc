...
void icemc::Tools::MakeGraph(int index, const int n,double *time,double *volts,TGraph *&mygraph,TH2F *&h2, double scalex,double scaley,std::string xaxistitle,std::string yaxistitle) {
...
void icemc::Tools::GetNextNumberAsString(std::ifstream& fin, std::ofstream& fout, std::string& number) {
  std::string temp;
...
void icemc::Tools::GetNumbersAsStringArray(std::ifstream& fin, std::ofstream& fout,std::vector<std::string>& vnumbers, int nelements) {
  std::string temp;
  //getline(fin,temp);
...
void icemc::Tools::GetNext2NumbersAsString(std::ifstream& fin,std::ofstream& fout,std::string& number1,std::string& number2, std::string& stherest) {
